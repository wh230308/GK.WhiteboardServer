...
namespace GK.WhiteboardServer
{
    ...
    public class Win32Usb
    {
        ...
        protected static extern IntPtr SetupDiGetClassDevs(ref Guid gClass, IntPtr Enumerator, IntPtr hParent, uint nFlags);
        /// <summary>
        ...
        //[DllImport("setupapi.dll", SetLastError = true)]
        //protected static extern bool SetupDiGetDeviceInterfaceDetail(IntPtr DeviceInfoSet, ref DeviceInterfaceData DeviceInterfaceData, IntPtr DeviceInterfaceDetailData, Int32 DeviceInterfaceDetailDataSize, ref Int32 RequiredSize, IntPtr DeviceInfoData);
        /// <summary>
